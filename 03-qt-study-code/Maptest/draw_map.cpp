...
void DrawMap::resizeEvent(QResizeEvent *event) {
    Q_UNUSED(event)
    UpdatePaperWidthOfPerPixel();
...
void DrawMap::enterEvent(QEvent *event) {
    Q_UNUSED(event)
}

void DrawMap::leaveEvent(QEvent *event) {
    Q_UNUSED(event)
}

void DrawMap::wheelEvent(QWheelEvent *event) {
    Q_UNUSED(event)
...
//paper_width :
//widget_width :
double DrawMap::CalcPaperWidthOfPerPixel(double scale_value,
                                                        int paper_width,
                                                        int widget_width) {
...
void DrawMap::UpdatePaperWidthOfPerPixel() {
...
void DrawMap::DrawPaper(QPainter &painter) {
...
QPoint DrawMap::MousePoint2PaperPoint(QPoint point) {
    QPoint ret;
